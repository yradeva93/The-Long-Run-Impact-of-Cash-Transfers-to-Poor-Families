This model asses the effect of the MP program on the natural logarithm of the age at death for a given individual i in family fborn in year t, living in county c (state s) and has the following functional form:
